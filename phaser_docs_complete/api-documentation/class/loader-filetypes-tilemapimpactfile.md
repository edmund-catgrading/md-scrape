...
| --- | --- | --- | --- |
| key | string | [Phaser.Types.Loader.FileTypes.TilemapImpactFileConfig](../typedef/types-loader-filetypes.md) | No | The key to use for this file, or a file configuration object. |
