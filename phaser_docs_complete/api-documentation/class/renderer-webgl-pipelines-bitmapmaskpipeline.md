...
**Returns:** [Phaser.Renderer.WebGL.Pipelines.BitmapMaskPipeline](renderer-webgl-pipelines-bitmapmaskpipeline.md) - `this`.
...
| --- | --- | --- | --- |
| maskedObject | [Phaser.GameObjects.GameObject](gameobjects-gameobject.md) | No | GameObject masked by the mask GameObject. |
...
**Returns:** [Phaser.Renderer.WebGL.Pipelines.BitmapMaskPipeline](renderer-webgl-pipelines-bitmapmaskpipeline.md) - This WebGLPipeline instance.
...
**Returns:** [Phaser.Renderer.WebGL.Pipelines.BitmapMaskPipeline](renderer-webgl-pipelines-bitmapmaskpipeline.md) - This WebGL Pipeline instance.
...
| name | type | optional | description |
| --- | --- | --- | --- |
| mask | [Phaser.Display.Masks.BitmapMask](display-masks-bitmapmask.md) | No | The BitmapMask instance that called endMask. |
| --- | --- | --- | --- |
...
* [Public Methods](#public-methods)
  ...
  + [beginMask](#beginmask)
    ...
    - [<instance> beginMask(mask, maskedObject, camera)](#instance-beginmaskmask-maskedobject-camera)
  + [bind](#bind)
  ...
  + [endMask](#endmask)
    ...
    - [<instance> endMask(mask, camera, [renderTarget])](#instance-endmaskmask-camera-rendertarget)
