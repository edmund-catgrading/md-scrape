...
### mixes: Phaser.Structs.Map.<string, [Phaser.Animations.Animation](animations-animation.md)>
...
| --- | --- | --- | --- |
| animation | [Phaser.Animations.Animation](animations-animation.md) | No | The Animation which should be added to the Animation Manager. |

**Returns:** [Phaser.Animations.AnimationManager](animations-animationmanager.md) - This Animation Manager.

**Fires:** [Phaser.Animations.Events#event:ADD\_ANIMATION](../event/animations-events.md)
...
**Returns:** [Phaser.Animations.AnimationManager](animations-animationmanager.md) - `this`.
...
| name | type | optional | description |
| --- | --- | --- | --- |
| animA | string | [Phaser.Animations.Animation](animations-animation.md) | No | The string-based key, or instance of, Animation A. |
| --- | --- | --- | --- |
| animB | string | [Phaser.Animations.Animation](animations-animation.md) | No | The string-based key, or instance of, Animation B. |
...
| target | [Phaser.Animations.AnimationManager](animations-animationmanager.md) | [Phaser.GameObjects.GameObject](gameobjects-gameobject.md) | Yes | Create the animations on this target Sprite. If not given, they will be created globally in this Animation Manager. |

**Returns:** Array.<[Phaser.Animations.Animation](animations-animation.md)> - An array of Animation instances that were successfully created.
...
| name | type | optional | default | description |
| --- | --- | --- | --- | --- |
| data | string | [Phaser.Types.Animations.JSONAnimations](../typedef/types-animations.md) | [Phaser.Types.Animations.JSONAnimation](../typedef/types-animations.md) | No |  |
| --- | --- | --- | --- | --- |
...
**Returns:** Array.<[Phaser.Animations.Animation](animations-animation.md)> - An array containing all of the Animation objects that were created as a result of this call.
...
**Returns:** [Phaser.Animations.Animation](animations-animation.md) - The Animation.
...
**Fires:** [Phaser.Animations.Events#event:PAUSE\_ALL](../event/animations-events.md)
...
| --- | --- | --- | --- |
| children | [Phaser.GameObjects.GameObject](gameobjects-gameobject.md) | Array.<[Phaser.GameObjects.GameObject](gameobjects-gameobject.md)> | No | An array of Game Objects to play the animation on. They must have an Animation Component. |
...
**Returns:** [Phaser.Animations.Animation](animations-animation.md) - The Animation instance that was removed from the Animation Manager.

**Fires:** [Phaser.Animations.Events#event:REMOVE\_ANIMATION](../event/animations-events.md)
...
| animA | string | [Phaser.Animations.Animation](animations-animation.md) | No | The string-based key, or instance of, Animation A. |
| --- | --- | --- | --- |
| animB | string | [Phaser.Animations.Animation](animations-animation.md) | Yes | The string-based key, or instance of, Animation B. If not given, all mixes for Animation A will be removed. |
...
**Fires:** [Phaser.Animations.Events#event:RESUME\_ALL](../event/animations-events.md)
...
**Returns:** [Phaser.Types.Animations.JSONAnimations](../typedef/types-animations.md) - The resulting JSONAnimations formatted object.
