...
| name | type | optional | description |
| --- | --- | --- | --- |
| key | string | [Phaser.Types.Loader.FileTypes.PluginFileConfig](/api-documentation/typedef/types-loader-filetypes#pluginfileconfig) | Array.<[Phaser.Types.Loader.FileTypes.PluginFileConfig](/api-documentation/typedef/types-loader-filetypes#pluginfileconfig)> | No |
| --- | --- | --- | --- |
...
**Returns:** [Phaser.Loader.LoaderPlugin](/api-documentation/class/loader-loaderplugin) - This Loader plugin.
...
| name | type | optional | description |
| --- | --- | --- | --- |
| key | string | [Phaser.Types.Loader.FileTypes.SceneFileConfig](/api-documentation/typedef/types-loader-filetypes#scenefileconfig) | Array.<[Phaser.Types.Loader.FileTypes.SceneFileConfig](/api-documentation/typedef/types-loader-filetypes#scenefileconfig)> | No |
| --- | --- | --- | --- |
...
| name | type | optional | description |
| --- | --- | --- | --- |
| key | string | [Phaser.Types.Loader.FileTypes.ScenePluginFileConfig](/api-documentation/typedef/types-loader-filetypes#scenepluginfileconfig) | Array.<[Phaser.Types.Loader.FileTypes.ScenePluginFileConfig](/api-documentation/typedef/types-loader-filetypes#scenepluginfileconfig)> | No |
| --- | --- | --- | --- |
...
| name | type | optional | default | description |
| --- | --- | --- | --- | --- |
| key | string | [Phaser.Types.Loader.FileTypes.ScriptFileConfig](/api-documentation/typedef/types-loader-filetypes#scriptfileconfig) | Array.<[Phaser.Types.Loader.FileTypes.ScriptFileConfig](/api-documentation/typedef/types-loader-filetypes#scriptfileconfig)> | No |  |
| --- | --- | --- | --- | --- |
| url | string | Yes |  | The absolute or relative URL to load this file from. If undefined or `null` it will be set to `<key>.js`, i.e. if `key` was "alien" then the URL will be "alien.js". |
...
| name | type | optional | default | description |
| --- | --- | --- | --- | --- |
| key | string | [Phaser.Types.Loader.FileTypes.MultiScriptFileConfig](/api-documentation/typedef/types-loader-filetypes#multiscriptfileconfig) | Array.<[Phaser.Types.Loader.FileTypes.MultiScriptFileConfig](/api-documentation/typedef/types-loader-filetypes#multiscriptfileconfig)> | No |  |
| --- | --- | --- | --- | --- |
...
| xhrSettings | [Phaser.Types.Loader.XHRSettingsObject](/api-documentation/typedef/types-loader#xhrsettingsobject) | Yes |  | Extra XHR Settings specifically for these files. |
...
**Returns:** [Phaser.Loader.LoaderPlugin](/api-documentation/class/loader-loaderplugin) - This Loader object.
...
| name | type | optional | description |
| --- | --- | --- | --- |
| key | string | [Phaser.Types.Loader.FileTypes.SpriteSheetFileConfig](/api-documentation/typedef/types-loader-filetypes#spritesheetfileconfig) | Array.<[Phaser.Types.Loader.FileTypes.SpriteSheetFileConfig](/api-documentation/typedef/types-loader-filetypes#spritesheetfileconfig)> | No |
| --- | --- | --- | --- |
...
| frameConfig | [Phaser.Types.Loader.FileTypes.ImageFrameConfig](/api-documentation/typedef/types-loader-filetypes#imageframeconfig) | Yes | The frame configuration object. At a minimum it should have a `frameWidth` property. |
| xhrSettings | [Phaser.Types.Loader.XHRSettingsObject](/api-documentation/typedef/types-loader#xhrsettingsobject) | Yes | An XHR Settings configuration object. Used in replacement of the Loaders default XHR Settings. |
...
**Fires:** [Phaser.Loader.Events#event:START](/api-documentation/event/loader-events#start)
...
| name | type | optional | description |
| --- | --- | --- | --- |
| key | string | [Phaser.Types.Loader.FileTypes.SVGFileConfig](/api-documentation/typedef/types-loader-filetypes#svgfileconfig) | Array.<[Phaser.Types.Loader.FileTypes.SVGFileConfig](/api-documentation/typedef/types-loader-filetypes#svgfileconfig)> | No |
| --- | --- | --- | --- |
...
| svgConfig | [Phaser.Types.Loader.FileTypes.SVGSizeConfig](/api-documentation/typedef/types-loader-filetypes#svgsizeconfig) | Yes | The svg size configuration object. |
| xhrSettings | [Phaser.Types.Loader.XHRSettingsObject](/api-documentation/typedef/types-loader#xhrsettingsobject) | Yes | An XHR Settings configuration object. Used in replacement of the Loaders default XHR Settings. |
...
| name | type | optional | description |
| --- | --- | --- | --- |
| key | string | [Phaser.Types.Loader.FileTypes.TextFileConfig](/api-documentation/typedef/types-loader-filetypes#textfileconfig) | Array.<[Phaser.Types.Loader.FileTypes.TextFileConfig](/api-documentation/typedef/types-loader-filetypes#textfileconfig)> | No |
| --- | --- | --- | --- |
...
| name | type | optional | description |
| --- | --- | --- | --- |
| key | string | [Phaser.Types.Loader.FileTypes.CompressedTextureFileConfig](/api-documentation/typedef/types-loader-filetypes#compressedtexturefileconfig) | Array.<[Phaser.Types.Loader.FileTypes.CompressedTextureFileConfig](/api-documentation/typedef/types-loader-filetypes#compressedtexturefileconfig)> | No |
| --- | --- | --- | --- |
| url | [Phaser.Types.Loader.FileTypes.CompressedTextureFileConfig](/api-documentation/typedef/types-loader-filetypes#compressedtexturefileconfig) | Yes | The compressed texture configuration object. Not required if passing a config object as the `key` parameter. |
| xhrSettings | [Phaser.Types.Loader.XHRSettingsObject](/api-documentation/typedef/types-loader#xhrsettingsobject) | Yes | An XHR Settings configuration object. Used in replacement of the Loaders default XHR Settings. |
...
| name | type | optional | description |
| --- | --- | --- | --- |
| key | string | [Phaser.Types.Loader.FileTypes.TilemapCSVFileConfig](/api-documentation/typedef/types-loader-filetypes#tilemapcsvfileconfig) | Array.<[Phaser.Types.Loader.FileTypes.TilemapCSVFileConfig](/api-documentation/typedef/types-loader-filetypes#tilemapcsvfileconfig)> | No |
| --- | --- | --- | --- |
...
| name | type | optional | description |
| --- | --- | --- | --- |
| key | string | [Phaser.Types.Loader.FileTypes.TilemapImpactFileConfig](/api-documentation/typedef/types-loader-filetypes#tilemapimpactfileconfig) | Array.<[Phaser.Types.Loader.FileTypes.TilemapImpactFileConfig](/api-documentation/typedef/types-loader-filetypes#tilemapimpactfileconfig)> | No |
| --- | --- | --- | --- |
| url | string | Yes | The absolute or relative URL to load this file from. If undefined or `null` it will be set to `<key>.json`, i.e. if `key` was "alien" then the URL will be "alien.json". |
| xhrSettings | [Phaser.Types.Loader.XHRSettingsObject](/api-documentation/typedef/types-loader#xhrsettingsobject) | Yes | An XHR Settings configuration object. Used in replacement of the Loaders default XHR Settings. |
...
| name | type | optional | description |
| --- | --- | --- | --- |
| key | string | [Phaser.Types.Loader.FileTypes.TilemapJSONFileConfig](/api-documentation/typedef/types-loader-filetypes#tilemapjsonfileconfig) | Array.<[Phaser.Types.Loader.FileTypes.TilemapJSONFileConfig](/api-documentation/typedef/types-loader-filetypes#tilemapjsonfileconfig)> | No |
| --- | --- | --- | --- |
...
| name | type | optional | description |
| --- | --- | --- | --- |
| key | string | [Phaser.Types.Loader.FileTypes.UnityAtlasFileConfig](/api-documentation/typedef/types-loader-filetypes#unityatlasfileconfig) | Array.<[Phaser.Types.Loader.FileTypes.UnityAtlasFileConfig](/api-documentation/typedef/types-loader-filetypes#unityatlasfileconfig)> | No |
| --- | --- | --- | --- |
| textureURL | string | Array.<string> | Yes | The absolute or relative URL to load the texture image file from. If undefined or `null` it will be set to `<key>.png`, i.e. if `key` was "alien" then the URL will be "alien.png". |
...
| textureXhrSettings | [Phaser.Types.Loader.XHRSettingsObject](/api-documentation/typedef/types-loader#xhrsettingsobject) | Yes | An XHR Settings configuration object for the atlas image file. Used in replacement of the Loaders default XHR Settings. |
| atlasXhrSettings | [Phaser.Types.Loader.XHRSettingsObject](/api-documentation/typedef/types-loader#xhrsettingsobject) | Yes | An XHR Settings configuration object for the atlas data file. Used in replacement of the Loaders default XHR Settings. |
...
**Fires:** [Phaser.Loader.Events#event:PROGRESS](/api-documentation/event/loader-events#progress)
...
| name | type | optional | default | description |
| --- | --- | --- | --- | --- |
| key | string | [Phaser.Types.Loader.FileTypes.VideoFileConfig](/api-documentation/typedef/types-loader-filetypes#videofileconfig) | Array.<[Phaser.Types.Loader.FileTypes.VideoFileConfig](/api-documentation/typedef/types-loader-filetypes#videofileconfig)> | No |  |
| --- | --- | --- | --- | --- |
| urls | string | Array.<string> | [Phaser.Types.Loader.FileTypes.VideoFileURLConfig](/api-documentation/typedef/types-loader-filetypes#videofileurlconfig) | Array.<[Phaser.Types.Loader.FileTypes.VideoFileURLConfig](/api-documentation/typedef/types-loader-filetypes#videofileurlconfig)> | Yes |
...
| name | type | optional | description |
| --- | --- | --- | --- |
| key | string | [Phaser.Types.Loader.FileTypes.XMLFileConfig](/api-documentation/typedef/types-loader-filetypes#xmlfileconfig) | Array.<[Phaser.Types.Loader.FileTypes.XMLFileConfig](/api-documentation/typedef/types-loader-filetypes#xmlfileconfig)> | No |
| --- | --- | --- | --- |
...
### cacheManager: [Phaser.Cache.CacheManager](/api-documentation/class/cache-cachemanager)
...
### sceneManager: [Phaser.Scenes.SceneManager](/api-documentation/class/scenes-scenemanager)
...
### systems: [Phaser.Scenes.Systems](/api-documentation/class/scenes-systems)
...
### xhr: [Phaser.Types.Loader.XHRSettingsObject](/api-documentation/typedef/types-loader#xhrsettingsobject)
